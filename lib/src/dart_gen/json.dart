...
import 'package:schemake/src/_text.dart';
...
/// this method returns the name that would've
/// been generated by [generateDart].
String schemaTypeString(SchemaType<Object?> type) {
  return switch (type) {
    ...
    Validatable<Object?>(type: var inner) => schemaTypeString(inner),
    Ints() => 'Ints()',
    Floats() => 'Floats()',
    Strings() => 'Strings()',
    Bools() => 'Bools()',
